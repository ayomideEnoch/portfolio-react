...
import ResumePDF from "../assets/Ayomide Ibosiola—Talent Acquisition Specialist.pdf"
...
export default function Home() {
  ...
  return (
    <Section id="about">
      ...
      I am a Data-driven Technical Recruiter capable of Advanced Boolean and X-ray Search to identify and mine top candidates with a strong Software Development background, specializing in building web and mobile applications that are aesthetically pleasing and logic-driven.<br></br>
      ...
      In addition to my knowledge base, I actively seek out new technologies and stay up-to-date on industry trends and advancements. <br></br>My core interests include:
        <ul>
          ...
          <li>And other Human Resources functions spanning across Tech startups.</li>
        </ul> 
      </p>
